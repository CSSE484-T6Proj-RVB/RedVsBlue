...
class RandomStringGenerator {
    ...
    var randomHangmanWords = ["balloon","baby", "back", "ball", "bank", "base", "basket", "bath", "bean", "bear", "bedroom", "beer", "behave", "before", "begin", "behind", "bell", "below", "besides", "best", "better", "between", "bird", "birth", "birthday"]
